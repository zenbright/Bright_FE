...
function ProjectDashboard() {
  ...
  return (
    <div className="flyInLeftToRight px-2 group-none overflow-x-scroll visible no-scrollbar rounded-r-md h-full bg-white border-r-2 w-[19.5vw] pt-2 flex flex-col justify-between">
