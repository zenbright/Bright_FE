...
const FilePreview = (attachment) => {
  const file_type = attachment.mimeType.substring(0, attachment.mimeType.indexOf('/'))
  ...
  const icon_element = typeof icon === 'function' ? icon(attachment.url, attachment.title) : icon
